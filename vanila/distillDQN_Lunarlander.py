...
from linearNet import TeacherNet_lunar, StudentNet_lunar
...
def distill_dqn(args=get_args()):
    ...
    buffer = VectorReplayBuffer(
        args.buffer_size, buffer_num=len(train_envs),)  # ignore_obs_next=True, save_only_last_obs=True, stack_num=args.frames_stack
