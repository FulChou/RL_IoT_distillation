...
LOGDIR="distill"
TASK=("Pong" "Breakout" "Enduro" "Qbert" "MsPacman" "Seaquest" "SpaceInvaders" "BeamRider")
 #"Freeway" "Riverraid")
resume_path=("/root/RL_IoT_distillation/vanila/log/vanilla/PongNoFrameskip-v4/dqn/seed_0_1206_063927-PongNoFrameskip_v4_vanilla/policy.pth"
