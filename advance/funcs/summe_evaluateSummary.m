function [f_measure, summary_length,recall, nn_f_meas, f_measure_seg] = summe_evaluateSummary(summary_selection,videoName,HOMEDATA,testIdx,evalIOU)
...
% f_measure is the mean pairwise f-measure used in Gygli et al. ECCV 2014
  ...
  nFrames=size(summary_selection,1);
  nbOfUsers=size(user_score,2);
  user_score=user_score(1:nFrames,:);
  %% Check inputs
